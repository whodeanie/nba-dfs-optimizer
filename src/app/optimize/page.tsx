    ...
    <div className="space-y-6 pt-8">
      <div>
        ...
        <p className="muted mt-2 text-sm max-w-2xl">
          Pick your site, contest type, and how many lineups you want. Add locks and excludes if you have a read. The MIP solver will deliver lineups inside the salary cap with full position legality, then Llama 3.3 70B will tell you the angle.
        </p>
      </div>
